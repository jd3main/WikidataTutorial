...
|||
|-|-|
| 2018/11/27 | 新增項目新增內容移至 [筆記A](https://demo.codimd.org/lhN0Je8zQ-SkbEUdv6jenw) |
| 2018/11/26 | 新增項目增加內容，待整理 |
| 2018/11/12 | 新增 [名詞說明](#名詞說明) 及 [良好的 Description](#良好的-Description)，以及若干小修改 |
| 2018/11/11 | 嘗試新套色 |
| 2018/11/10 | 新增 [在其他 wiki 裡使用 data](#在其他-wiki-裡使用-data) 取代舊段落 |
:::
...
### 項目新增範例
>為了讓大家容易上手，這邊提供幾種常見的項目可新增的內容做教學參考



## 資料的表示方式 - RDF
Wikidata 採用 [RDF](https://en.wikipedia.org/wiki/Resource_Description_Framework) 模型儲存。
以 **項目-屬性-值** 的三元組(triples) 為單位
形式如：
```
<item> <property> <value>
```
在官方說明文件裡可能會用一種比較文言的說法：

```
<subject> <predicate> <object>
```
例如，地球半徑是 6371 KM，可能寫成
```
Earth Radius 6371
```
